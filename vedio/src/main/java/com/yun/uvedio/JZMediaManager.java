...
public class JZMediaManager implements TextureView.SurfaceTextureListener {
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i1) {
        ...
        Log.d(TAG, "width ->" + i + ", height ->" + i1);
//        URxBus.get().post(new RxBean(RxBusConfig.VEDIO_TYPE, RxBusConfig.VEDIO_PORTRAIT, new VedioBean(i, i1)));
    ...
    public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i1) {
        Log.d(TAG, "onSurfaceTextureSizeChanged(*) width ->" + i + ", height ->" + i1);
//        if (i1 > i) {//竖屏
             URxBus.get().post(new RxBean(RxBusConfig.VEDIO_TYPE, RxBusConfig.VEDIO_PORTRAIT, new VedioBean(i, i1)));
//        } else {
//            URxBus.get().post(new RxBean(RxBusConfig.VEDIO_TYPE, RxBusConfig.VEDIO_LANDSCAPE, new VedioBean(i, i1)));
//        }
    }
    @Override
